...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='channel_wise_scale_param', full_name='caffe.LayerParameter.channel_wise_scale_param', index=17,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='interp_param', full_name='caffe.LayerParameter.interp_param', index=37,
...
_TRANSFORMATIONPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pad', full_name='caffe.TransformationParameter.pad', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='std_value', full_name='caffe.TransformationParameter.std_value', index=11,
...
_LOSSPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='hybrid_thresh', full_name='caffe.LossParameter.hybrid_thresh', index=3,
      number=4, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='hybrid_type', full_name='caffe.LossParameter.hybrid_type', index=4,
      number=5, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_IMAGEDATAPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='normalize', full_name='caffe.ImageDataParameter.normalize', index=14,
      number=17, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='label_channel', full_name='caffe.ImageDataParameter.label_channel', index=15,
...
_CHANNELWISESCALEPARAMETER = _descriptor.Descriptor(
  name='ChannelWiseScaleParameter',
  full_name='caffe.ChannelWiseScaleParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='axis', full_name='caffe.ChannelWiseScaleParameter.axis', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='weight_filler', full_name='caffe.ChannelWiseScaleParameter.weight_filler', index=1,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='scale_dim', full_name='caffe.ChannelWiseScaleParameter.scale_dim', index=2,
...
_LAYERPARAMETER.fields_by_name['channel_wise_scale_param'].message_type = _CHANNELWISESCALEPARAMETER
...
_CHANNELWISESCALEPARAMETER.fields_by_name['weight_filler'].message_type = _FILLERPARAMETER
...
DESCRIPTOR.message_types_by_name['ChannelWiseScaleParameter'] = _CHANNELWISESCALEPARAMETER
...
ChannelWiseScaleParameter = _reflection.GeneratedProtocolMessageType('ChannelWiseScaleParameter', (_message.Message,), dict(
  DESCRIPTOR = _CHANNELWISESCALEPARAMETER,
  __module__ = 'caffe.proto.caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.ChannelWiseScaleParameter)
  ))
_sym_db.RegisterMessage(ChannelWiseScaleParameter)
