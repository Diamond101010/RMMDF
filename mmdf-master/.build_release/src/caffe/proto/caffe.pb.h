...
class ChannelWiseScaleParameter;
...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.ChannelWiseScaleParameter channel_wise_scale_param = 148;
  inline bool has_channel_wise_scale_param() const;
  inline void clear_channel_wise_scale_param();
  static const int kChannelWiseScaleParamFieldNumber = 148;
  inline const ::caffe::ChannelWiseScaleParameter& channel_wise_scale_param() const;
  inline ::caffe::ChannelWiseScaleParameter* mutable_channel_wise_scale_param();
  inline ::caffe::ChannelWiseScaleParameter* release_channel_wise_scale_param();
  inline void set_allocated_channel_wise_scale_param(::caffe::ChannelWiseScaleParameter* channel_wise_scale_param);
  ...
  // optional .caffe.InterpParameter interp_param = 149;
  inline bool has_interp_param() const;
  inline void clear_interp_param();
  static const int kInterpParamFieldNumber = 149;
  ...
  // optional .caffe.ROIPoolingParameter roi_pooling_param = 170;
  inline bool has_roi_pooling_param() const;
  inline void clear_roi_pooling_param();
  static const int kRoiPoolingParamFieldNumber = 170;
 ...
 private:
  ...
  inline void set_has_channel_wise_scale_param();
  inline void clear_has_channel_wise_scale_param();
  ...
  ::caffe::ChannelWiseScaleParameter* channel_wise_scale_param_;
...
class TransformationParameter : public ::google::protobuf::Message {
 public:
  ...
  inline int scale_factors_size() const;
  inline void clear_scale_factors();
  static const int kScaleFactorsFieldNumber = 8;
  inline float scale_factors(int index) const;
  inline void set_scale_factors(int index, float value);
  inline void add_scale_factors(float value);
  inline const ::google::protobuf::RepeatedField< float >&
      scale_factors() const;
  inline ::google::protobuf::RepeatedField< float >*
  ...
  static const int kCropWidthFieldNumber = 9;
  ...
  static const int kCropHeightFieldNumber = 10;
  inline ::google::protobuf::uint32 crop_height() const;
  inline void set_crop_height(::google::protobuf::uint32 value);

  // optional uint32 pad = 11 [default = 0];
  inline bool has_pad() const;
  inline void clear_pad();
  static const int kPadFieldNumber = 11;
  inline ::google::protobuf::uint32 pad() const;
  inline void set_pad(::google::protobuf::uint32 value);

  // repeated float std_value = 12;
  inline int std_value_size() const;
  inline void clear_std_value();
  static const int kStdValueFieldNumber = 12;
  inline float std_value(int index) const;
  inline void set_std_value(int index, float value);
  inline void add_std_value(float value);
  inline const ::google::protobuf::RepeatedField< float >&
      std_value() const;
  inline ::google::protobuf::RepeatedField< float >*
      mutable_std_value();
 ...
 private:
  ...
  ::google::protobuf::RepeatedField< float > scale_factors_;
  ::google::protobuf::uint32 crop_height_;
  ::google::protobuf::uint32 pad_;
  ::google::protobuf::RepeatedField< float > std_value_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
  friend void protobuf_ShutdownFile_caffe_2eproto();
...
class LossParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional float hybrid_thresh = 4 [default = 0];
  inline bool has_hybrid_thresh() const;
  inline void clear_hybrid_thresh();
  static const int kHybridThreshFieldNumber = 4;
  inline float hybrid_thresh() const;
  inline void set_hybrid_thresh(float value);

  // optional int32 hybrid_type = 5 [default = 0];
  inline bool has_hybrid_type() const;
  inline void clear_hybrid_type();
  static const int kHybridTypeFieldNumber = 5;
  inline ::google::protobuf::int32 hybrid_type() const;
  inline void set_hybrid_type(::google::protobuf::int32 value);
 ...
 private:
  ...
  inline void set_has_hybrid_thresh();
  inline void clear_has_hybrid_thresh();
  inline void set_has_hybrid_type();
  inline void clear_has_hybrid_type();
  ...
  int normalization_;
  bool normalize_;
  float hybrid_thresh_;
  ::google::protobuf::int32 hybrid_type_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
  friend void protobuf_ShutdownFile_caffe_2eproto();
...
class ImageDataParameter : public ::google::protobuf::Message {
 public:
  ...
  static const LabelType NONE = ImageDataParameter_LabelType_NONE;
  static const LabelType IMAGE = ImageDataParameter_LabelType_IMAGE;
  static const LabelType PIXEL = ImageDataParameter_LabelType_PIXEL;
  ...
  inline ::caffe::ImageDataParameter_LabelType label_type() const;
  inline void set_label_type(::caffe::ImageDataParameter_LabelType value);
  ...
  // optional bool normalize = 17 [default = false];
  inline bool has_normalize() const;
  inline void clear_normalize();
  static const int kNormalizeFieldNumber = 17;
  inline bool normalize() const;
  inline void set_normalize(bool value);

  // optional uint32 label_channel = 18 [default = 1];
  inline bool has_label_channel() const;
  inline void clear_label_channel();
  static const int kLabelChannelFieldNumber = 18;
  inline ::google::protobuf::uint32 label_channel() const;
  inline void set_label_channel(::google::protobuf::uint32 value);
 ...
 private:
  ...
  inline void set_has_normalize();
  inline void clear_has_normalize();
  inline void set_has_label_channel();
  inline void clear_has_label_channel();
  ...
  ::google::protobuf::uint32 crop_size_;
  ::google::protobuf::uint32 label_channel_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
  friend void protobuf_ShutdownFile_caffe_2eproto();
...
class ChannelWiseScaleParameter : public ::google::protobuf::Message {
 public:
  ChannelWiseScaleParameter();
  virtual ~ChannelWiseScaleParameter();

  ChannelWiseScaleParameter(const ChannelWiseScaleParameter& from);

  inline ChannelWiseScaleParameter& operator=(const ChannelWiseScaleParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const ChannelWiseScaleParameter& default_instance();

  void Swap(ChannelWiseScaleParameter* other);

  // implements Message ----------------------------------------------

  ChannelWiseScaleParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const ChannelWiseScaleParameter& from);
  void MergeFrom(const ChannelWiseScaleParameter& from);
  void Clear();
  bool IsInitialized() const;
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static ChannelWiseScaleParameter* default_instance_;
};
// -------------------------------------------------------------------
...
// optional .caffe.ChannelWiseScaleParameter channel_wise_scale_param = 148;
inline bool LayerParameter::has_channel_wise_scale_param() const {
  return (_has_bits_[0] & 0x00020000u) != 0;
}
inline void LayerParameter::set_has_channel_wise_scale_param() {
  _has_bits_[0] |= 0x00020000u;
}
inline void LayerParameter::clear_has_channel_wise_scale_param() {
  _has_bits_[0] &= ~0x00020000u;
}
inline void LayerParameter::clear_channel_wise_scale_param() {
  if (channel_wise_scale_param_ != NULL) channel_wise_scale_param_->::caffe::ChannelWiseScaleParameter::Clear();
  clear_has_channel_wise_scale_param();
}
inline const ::caffe::ChannelWiseScaleParameter& LayerParameter::channel_wise_scale_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.channel_wise_scale_param)
  return channel_wise_scale_param_ != NULL ? *channel_wise_scale_param_ : *default_instance_->channel_wise_scale_param_;
}
inline ::caffe::ChannelWiseScaleParameter* LayerParameter::mutable_channel_wise_scale_param() {
  set_has_channel_wise_scale_param();
  if (channel_wise_scale_param_ == NULL) channel_wise_scale_param_ = new ::caffe::ChannelWiseScaleParameter;
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.channel_wise_scale_param)
  return channel_wise_scale_param_;
}
inline ::caffe::ChannelWiseScaleParameter* LayerParameter::release_channel_wise_scale_param() {
  clear_has_channel_wise_scale_param();
  ::caffe::ChannelWiseScaleParameter* temp = channel_wise_scale_param_;
  channel_wise_scale_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_channel_wise_scale_param(::caffe::ChannelWiseScaleParameter* channel_wise_scale_param) {
  delete channel_wise_scale_param_;
  channel_wise_scale_param_ = channel_wise_scale_param;
  if (channel_wise_scale_param) {
    set_has_channel_wise_scale_param();
  } else {
    clear_has_channel_wise_scale_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.channel_wise_scale_param)
}
...
// repeated float scale_factors = 8;
inline int TransformationParameter::scale_factors_size() const {
  return scale_factors_.size();
}
inline void TransformationParameter::clear_scale_factors() {
  scale_factors_.Clear();
}
inline float TransformationParameter::scale_factors(int index) const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.scale_factors)
  return scale_factors_.Get(index);
}
inline void TransformationParameter::set_scale_factors(int index, float value) {
  scale_factors_.Set(index, value);
  // @@protoc_insertion_point(field_set:caffe.TransformationParameter.scale_factors)
}
inline void TransformationParameter::add_scale_factors(float value) {
  scale_factors_.Add(value);
  // @@protoc_insertion_point(field_add:caffe.TransformationParameter.scale_factors)
}
inline const ::google::protobuf::RepeatedField< float >&
TransformationParameter::scale_factors() const {
  // @@protoc_insertion_point(field_list:caffe.TransformationParameter.scale_factors)
  return scale_factors_;
}
inline ::google::protobuf::RepeatedField< float >*
TransformationParameter::mutable_scale_factors() {
  // @@protoc_insertion_point(field_mutable_list:caffe.TransformationParameter.scale_factors)
  return &scale_factors_;
}

// optional uint32 crop_width = 9 [default = 0];
inline bool TransformationParameter::has_crop_width() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void TransformationParameter::set_has_crop_width() {
  _has_bits_[0] |= 0x00000100u;
}
inline void TransformationParameter::clear_has_crop_width() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void TransformationParameter::clear_crop_width() {
  crop_width_ = 0u;
  clear_has_crop_width();
}
inline ::google::protobuf::uint32 TransformationParameter::crop_width() const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.crop_width)
  return crop_width_;
}
inline void TransformationParameter::set_crop_width(::google::protobuf::uint32 value) {
  set_has_crop_width();
  crop_width_ = value;
  // @@protoc_insertion_point(field_set:caffe.TransformationParameter.crop_width)
}

// optional uint32 crop_height = 10 [default = 0];
inline bool TransformationParameter::has_crop_height() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void TransformationParameter::set_has_crop_height() {
  _has_bits_[0] |= 0x00000200u;
}
inline void TransformationParameter::clear_has_crop_height() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void TransformationParameter::clear_crop_height() {
  crop_height_ = 0u;
  clear_has_crop_height();
}
inline ::google::protobuf::uint32 TransformationParameter::crop_height() const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.crop_height)
  return crop_height_;
}
inline void TransformationParameter::set_crop_height(::google::protobuf::uint32 value) {
  set_has_crop_height();
  crop_height_ = value;
  // @@protoc_insertion_point(field_set:caffe.TransformationParameter.crop_height)
}
...
inline void TransformationParameter::set_has_pad() {
  _has_bits_[0] |= 0x00000400u;
}
inline void TransformationParameter::clear_has_pad() {
  _has_bits_[0] &= ~0x00000400u;
}
...
inline ::google::protobuf::uint32 TransformationParameter::pad() const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.pad)
  return pad_;
}
inline void TransformationParameter::set_pad(::google::protobuf::uint32 value) {
  set_has_pad();
  pad_ = value;
...
// repeated float std_value = 12;
inline int TransformationParameter::std_value_size() const {
  return std_value_.size();
}
inline void TransformationParameter::clear_std_value() {
  std_value_.Clear();
}
inline float TransformationParameter::std_value(int index) const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.std_value)
  return std_value_.Get(index);
}
inline void TransformationParameter::set_std_value(int index, float value) {
  std_value_.Set(index, value);
  // @@protoc_insertion_point(field_set:caffe.TransformationParameter.std_value)
}
inline void TransformationParameter::add_std_value(float value) {
  std_value_.Add(value);
  // @@protoc_insertion_point(field_add:caffe.TransformationParameter.std_value)
}
inline const ::google::protobuf::RepeatedField< float >&
TransformationParameter::std_value() const {
  // @@protoc_insertion_point(field_list:caffe.TransformationParameter.std_value)
  return std_value_;
}
inline ::google::protobuf::RepeatedField< float >*
TransformationParameter::mutable_std_value() {
  // @@protoc_insertion_point(field_mutable_list:caffe.TransformationParameter.std_value)
  return &std_value_;
}
...
// optional float hybrid_thresh = 4 [default = 0];
inline bool LossParameter::has_hybrid_thresh() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void LossParameter::set_has_hybrid_thresh() {
  _has_bits_[0] |= 0x00000008u;
}
inline void LossParameter::clear_has_hybrid_thresh() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void LossParameter::clear_hybrid_thresh() {
  hybrid_thresh_ = 0;
  clear_has_hybrid_thresh();
}
inline float LossParameter::hybrid_thresh() const {
  // @@protoc_insertion_point(field_get:caffe.LossParameter.hybrid_thresh)
  return hybrid_thresh_;
}
inline void LossParameter::set_hybrid_thresh(float value) {
  set_has_hybrid_thresh();
  hybrid_thresh_ = value;
  // @@protoc_insertion_point(field_set:caffe.LossParameter.hybrid_thresh)
}

// optional int32 hybrid_type = 5 [default = 0];
inline bool LossParameter::has_hybrid_type() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void LossParameter::set_has_hybrid_type() {
  _has_bits_[0] |= 0x00000010u;
}
inline void LossParameter::clear_has_hybrid_type() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void LossParameter::clear_hybrid_type() {
  hybrid_type_ = 0;
  clear_has_hybrid_type();
}
inline ::google::protobuf::int32 LossParameter::hybrid_type() const {
  // @@protoc_insertion_point(field_get:caffe.LossParameter.hybrid_type)
  return hybrid_type_;
}
inline void LossParameter::set_hybrid_type(::google::protobuf::int32 value) {
  set_has_hybrid_type();
  hybrid_type_ = value;
  // @@protoc_insertion_point(field_set:caffe.LossParameter.hybrid_type)
}
...
// optional bool normalize = 17 [default = false];
inline bool ImageDataParameter::has_normalize() const {
  return (_has_bits_[0] & 0x00004000u) != 0;
}
inline void ImageDataParameter::set_has_normalize() {
  _has_bits_[0] |= 0x00004000u;
}
inline void ImageDataParameter::clear_has_normalize() {
  _has_bits_[0] &= ~0x00004000u;
}
inline void ImageDataParameter::clear_normalize() {
  normalize_ = false;
  clear_has_normalize();
}
inline bool ImageDataParameter::normalize() const {
  // @@protoc_insertion_point(field_get:caffe.ImageDataParameter.normalize)
  return normalize_;
}
inline void ImageDataParameter::set_normalize(bool value) {
  set_has_normalize();
  normalize_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImageDataParameter.normalize)
}

// optional uint32 label_channel = 18 [default = 1];
inline bool ImageDataParameter::has_label_channel() const {
  return (_has_bits_[0] & 0x00008000u) != 0;
}
inline void ImageDataParameter::set_has_label_channel() {
  _has_bits_[0] |= 0x00008000u;
}
inline void ImageDataParameter::clear_has_label_channel() {
  _has_bits_[0] &= ~0x00008000u;
}
inline void ImageDataParameter::clear_label_channel() {
  label_channel_ = 1u;
  clear_has_label_channel();
}
inline ::google::protobuf::uint32 ImageDataParameter::label_channel() const {
  // @@protoc_insertion_point(field_get:caffe.ImageDataParameter.label_channel)
  return label_channel_;
}
inline void ImageDataParameter::set_label_channel(::google::protobuf::uint32 value) {
  set_has_label_channel();
  label_channel_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImageDataParameter.label_channel)
}
...
// optional int32 axis = 1 [default = 1];
inline bool ChannelWiseScaleParameter::has_axis() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void ChannelWiseScaleParameter::set_has_axis() {
  _has_bits_[0] |= 0x00000001u;
}
inline void ChannelWiseScaleParameter::clear_has_axis() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void ChannelWiseScaleParameter::clear_axis() {
  axis_ = 1;
  clear_has_axis();
}
inline ::google::protobuf::int32 ChannelWiseScaleParameter::axis() const {
  // @@protoc_insertion_point(field_get:caffe.ChannelWiseScaleParameter.axis)
  return axis_;
}
inline void ChannelWiseScaleParameter::set_axis(::google::protobuf::int32 value) {
  set_has_axis();
  axis_ = value;
  // @@protoc_insertion_point(field_set:caffe.ChannelWiseScaleParameter.axis)
}

// optional .caffe.FillerParameter weight_filler = 3;
inline bool ChannelWiseScaleParameter::has_weight_filler() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void ChannelWiseScaleParameter::set_has_weight_filler() {
  _has_bits_[0] |= 0x00000002u;
}
inline void ChannelWiseScaleParameter::clear_has_weight_filler() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void ChannelWiseScaleParameter::clear_weight_filler() {
  if (weight_filler_ != NULL) weight_filler_->::caffe::FillerParameter::Clear();
  clear_has_weight_filler();
}
inline const ::caffe::FillerParameter& ChannelWiseScaleParameter::weight_filler() const {
  // @@protoc_insertion_point(field_get:caffe.ChannelWiseScaleParameter.weight_filler)
  return weight_filler_ != NULL ? *weight_filler_ : *default_instance_->weight_filler_;
}
inline ::caffe::FillerParameter* ChannelWiseScaleParameter::mutable_weight_filler() {
  set_has_weight_filler();
  if (weight_filler_ == NULL) weight_filler_ = new ::caffe::FillerParameter;
  // @@protoc_insertion_point(field_mutable:caffe.ChannelWiseScaleParameter.weight_filler)
  return weight_filler_;
}
inline ::caffe::FillerParameter* ChannelWiseScaleParameter::release_weight_filler() {
  clear_has_weight_filler();
  ::caffe::FillerParameter* temp = weight_filler_;
  weight_filler_ = NULL;
  return temp;
}
inline void ChannelWiseScaleParameter::set_allocated_weight_filler(::caffe::FillerParameter* weight_filler) {
  delete weight_filler_;
  weight_filler_ = weight_filler;
  if (weight_filler) {
    set_has_weight_filler();
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.ChannelWiseScaleParameter.weight_filler)
}

// required int32 scale_dim = 2;
inline bool ChannelWiseScaleParameter::has_scale_dim() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void ChannelWiseScaleParameter::set_has_scale_dim() {
  _has_bits_[0] |= 0x00000004u;
}
inline void ChannelWiseScaleParameter::clear_has_scale_dim() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void ChannelWiseScaleParameter::clear_scale_dim() {
  scale_dim_ = 0;
  clear_has_scale_dim();
}
inline ::google::protobuf::int32 ChannelWiseScaleParameter::scale_dim() const {
  // @@protoc_insertion_point(field_get:caffe.ChannelWiseScaleParameter.scale_dim)
  return scale_dim_;
}
inline void ChannelWiseScaleParameter::set_scale_dim(::google::protobuf::int32 value) {
  set_has_scale_dim();
  scale_dim_ = value;
  // @@protoc_insertion_point(field_set:caffe.ChannelWiseScaleParameter.scale_dim)
}
...
template <> struct is_proto_enum< ::caffe::ImageDataParameter_LabelType> : ::google::protobuf::internal::true_type {};
template <>
